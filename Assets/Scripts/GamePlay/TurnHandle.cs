...
public class TurnHandle : MonoBehaviour , IOnEventCallback
{
    ...
    List<Vector3> PositionList = new List<Vector3>(){
        new Vector3(0,-600f,0),  //350
        new Vector3(0f,700f,0),
...
//        photonView.RPC("messageEveryone",RpcTarget.All,"Player turn "+ turn );
    ...
    void ActivatePlayerUIComponents()
    {
        ...
        PositionSlider.GetComponent<RectTransform>().anchoredPosition = PositionList[PhotonNetwork.LocalPlayer.ActorNumber -1]; 
        UIslider.SetActive(turn == PhotonNetwork.LocalPlayer.ActorNumber);
        PositionSlider.gameObject.SetActive(turn == PhotonNetwork.LocalPlayer.ActorNumber);
